...
var tables = []string{
	...
	`CREATE TABLE IF NOT EXISTS file_resources (id TEXT PRIMARY KEY, file_id TEXT, resource_id TEXT)`,
	...
	`CREATE TABLE IF NOT EXISTS bookings (id TEXT PRIMARY KEY, resource_ids TEXT NOT NULL, lead_id TEXT REFERENCES leads(id), start_time TIMESTAMP NOT NULL, end_time TIMESTAMP NOT NULL, status TEXT NOT NULL, shopify_order_id TEXT, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
...
var indexes = []string{
	...
	`CREATE INDEX IF NOT EXISTS idx_file_resources_file_id ON file_resources (file_id)`,
	`CREATE INDEX IF NOT EXISTS idx_file_resources_resource_id ON file_resources (resource_id)`,
